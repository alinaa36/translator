...
export const translate = (req:IncomingMessage, res:ServerResponse) => {
...
export const translateFile = (req:IncomingMessage, res:ServerResponse) => {
...
export const translateToFile = (req:IncomingMessage, res:ServerResponse) => {
